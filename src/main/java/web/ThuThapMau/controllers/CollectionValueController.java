...
public class CollectionValueController {
    ...
    @PostMapping
    public ResponseEntity<String> createValue(@RequestPart("userId") String user_id, @RequestPart("collectionFormId") String collection_form_id, @RequestPart("valueDtos") String valueDtosJson, @RequestPart("lastIdx") String lastIdx, @RequestPart("files") List<MultipartFile> files) throws JsonProcessingException {
